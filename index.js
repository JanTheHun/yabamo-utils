...
var server = new server_1.ServerInstance();
// mainAsync()
mainSync();
function mainSync() {
    return __awaiter(this, void 0, void 0, function () {
        var createResult, startResult;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log('creating..');
                    createResult = server.createSync(config);
...
function mainAsync() {
    return __awaiter(this, void 0, void 0, function () {
        var creation, starting, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, server.create(config)];
                case 1:
                    creation = _a.sent();
